...
import (
	...
	"oldnicke/etcd/etcdserver/api/v3election"
	"oldnicke/etcd/etcdserver/api/v3election/v3electionpb"
	v3electiongw "oldnicke/etcd/etcdserver/api/v3election/v3electionpb/gw"
	"oldnicke/etcd/etcdserver/api/v3lock"
	"oldnicke/etcd/etcdserver/api/v3lock/v3lockpb"
	v3lockgw "oldnicke/etcd/etcdserver/api/v3lock/v3lockpb/gw"
	"oldnicke/etcd/etcdserver/api/v3rpc"
	etcdservergw "oldnicke/etcd/etcdserver/etcdserverpb/gw"
