...
running(leaking) after all tests.
	...
	import "oldnicke/etcd/pkg/testutil"
...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "oldnicke/etcd/pkg/testutil.interestingGoroutines") ||
			strings.Contains(stack, "oldnicke/etcd/pkg/logutil.(*MergeLogger).outputLoop") ||
