...
[![GoDoc](https://godoc.org/github.com/oldnicke/etcd/client?status.png)](https://godoc.org/github.com/oldnicke/etcd/client)
...
```bash
go get github.com/oldnicke/etcd/client
```
