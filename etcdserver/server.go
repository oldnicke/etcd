...
import (
	...
	"oldnicke/etcd/etcdserver/api/v3alarm"
	"oldnicke/etcd/etcdserver/api/v3compactor"
...
var (
	plog = capnslog.NewPackageLogger("oldnicke/etcd", "etcdserver")
